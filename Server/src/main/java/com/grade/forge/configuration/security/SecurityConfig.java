        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request->
                        request
                                ...
                                .requestMatchers("/api/v1/student/*", "/api/v1/student/courses/**/groups/**").hasAnyAuthority("STUDENT","FACULTY","UNIVERSITY_ADMIN","SYSTEM_ADMIN")
                                .requestMatchers("/api/v1/grading-assistant/*").hasAuthority("GRADING_ASSISTANT")
                                .requestMatchers("/api/v1/faculty/courses/*","/api/v1/faculty/courses/**/groups/**","/api/v1/faculty/semester/").hasAuthority("FACULTY")
