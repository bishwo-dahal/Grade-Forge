        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request->
                        request
                                ...
                                .requestMatchers("/api/v1/faculty/rubrics/**").hasAuthority("FACULTY")
                                // IMPORTANT: Faculty roster search/enroll APIs must stay faculty-restricted.
                                .requestMatchers("/api/v1/faculty/enrollments/**").hasAuthority("FACULTY")
