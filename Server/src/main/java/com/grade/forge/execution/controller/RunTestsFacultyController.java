...
public class RunTestsFacultyController {
    ...
    public ResponseEntity<RunTestsResponse> requestRunTests(@AuthenticationPrincipal CustomUserDetails user,
        ...
        submissionService.ensureFacultyCanAccessSubmission(user.getUsername(), submissionId);
    ...
    public ResponseEntity<TestRunJobStatusResponse> getRunByJobId(@AuthenticationPrincipal CustomUserDetails user,
        ...
        submissionService.ensureFacultyCanAccessSubmission(user.getUsername(), job.getSubmission().getId());
