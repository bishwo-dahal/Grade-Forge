...
## How does a student view the rubric?

1. Open the assignment **Rubric** tab. It is read-only for students.
...
## How does a student see group membership?

1. Open the **Group** tab when the assignment uses groups.

**Path:** `/assignment/{assignmentId}` (Group tab)  
**Example URL:** [https://ulm.gradeforge.tech/assignment/12](https://ulm.gradeforge.tech/assignment/12)

## How does a faculty member list rubrics?
...
## How does a faculty member create a rubric?

1. From **Rubrics**, choose **New** or **Create**.
...
## How does a faculty member edit a rubric?
...
## How does a faculty member open main group details?

1. From the class **Groups** flow, open a main group.
