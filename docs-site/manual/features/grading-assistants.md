...
## What can a grading assistant do?

Grading assistants help instructors **grade** inside **courses** they are assigned to. They do **not** create university-wide configuration or their own classes.

## How do I see my courses?

1. Sign in as a grading assistant.
...
Your **instructor** or **university admin** controls that in the main app. If a class is missing, ask your instructor.
