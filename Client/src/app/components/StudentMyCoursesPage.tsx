...
function StudentMyCoursesView({ courses, layoutMode, onLayoutModeChange }: StudentMyCoursesViewProps) {
...
export function StudentMyCoursesPage() {
  ...
  return (
    <AuthShell
      ...
      mainContent={<StudentMyCoursesView courses={courses} layoutMode={layoutMode} onLayoutModeChange={setLayoutMode} />}
    />
  );
}
