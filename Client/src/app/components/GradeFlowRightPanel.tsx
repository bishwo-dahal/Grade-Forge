...
export function GradeFlowRightPanel() {
  ...
  return <GradeFlowRightPanelView alerts={alerts} taskDays={taskDays} />;
}

function GradeFlowRightPanelView({ alerts, taskDays }: GradeFlowRightPanelViewProps) {
