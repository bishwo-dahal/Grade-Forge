...
interface GradeFlowSidebarProps {
  viewMode: 'student' | 'faculty';
  onViewChange: (view: 'student' | 'faculty') => void;
}

export function GradeFlowSidebar({ viewMode, onViewChange }: GradeFlowSidebarProps) {
  const studentItems = [
    ...
    <aside className="w-60 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col">
      ...
      <div className="px-6 py-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[15px] font-semibold text-[#2B2A2A]">GradeFlow</span>
        </div>
      </div>
